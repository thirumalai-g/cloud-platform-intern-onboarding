...
require "Sampleproject-BookList/version"

Gem::Specification.new do |spec|
  spec.name          = "Sampleproject-BookList"
  spec.version       = Booklist::VERSION
  spec.authors       = ["pmi-thiruvenkadakrishnan-s"]
  spec.email         = ["thiruvenkadakrishnan@poshmark.com"]
